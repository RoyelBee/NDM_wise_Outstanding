...
# plot
barWidth = 0.80
names = ('A- 0 to 3 Days', 'B- 4 to 10 Days', 'C- 11 to 15 Days', 'D- 16 to 30 Days', 'E- 31 to 90 Days', 'F- 91 to 201 Days',
         'G- 202+ Days')
...
for bar in bar1:
    ...
    ax.text(bar.get_x() + bar.get_width() / 2, height * .99, str(int(height)) + '%', ha='center', va='bottom', fontweight='bold')
...
# lib.plt.show()
lib.plt.savefig('../Images/matured_credit_aging.png')
