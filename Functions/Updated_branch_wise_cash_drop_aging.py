...
def branch_wise_cash_drop_aging():
    ...
    # # --------------------- Creating fig-----------------------------------------
    zeroTothree = branch_cash_drop_df['0 - 3 days'].values.tolist()
    fourToten = branch_cash_drop_df['4 - 10 days'].values.tolist()
    elevenTofifteen = branch_cash_drop_df['11 - 15 days'].values.tolist()
    sixteenplus = branch_cash_drop_df['16+ days'].values.tolist()
    ...
    label_data = [all_zero_three, all_four_ten, all_eleven_fifteen, all_sixteen_therty]
